<section class="hero">
    <div class="container">
        <div>
            ...
            <div class="cluster">
                <a href="<?= e(url('/cours')) ?>" class="btn btn-primary">Explorer le catalogue</a>
                <a href="<?= e(url('/inscription')) ?>" class="btn btn-outline">Creer un compte gratuit</a>
            </div>
    ...
    <div class="container">
        ...
        <div class="tag-list">
            <?php foreach ($categories as $categorie): ?>
                <a href="<?= e(url('/cours') . query_with(['categorie' => $categorie['nom']])) ?>" class="badge badge-primaire" style="padding:8px 16px;font-size:.82rem;text-transform:none;letter-spacing:0;">
                    <?= e($categorie['nom']) ?>
                </a>
            <?php endforeach; ?>
        </div>
...
<section class="section" style="background:var(--color-surface);border-top:1px solid var(--color-border);border-bottom:1px solid var(--color-border);">
    <div class="container">
        <div class="section-head">
            ...
            <a href="<?= e(url('/cours')) ?>" class="btn btn-outline btn-sm">Voir tout le catalogue</a>
        </div>
            ...
            <div class="grid grid-cols-3">
                <?php foreach ($coursRecents as $cours): ?>
                    <article class="card course-card">
                        ...
                        <div class="card-body">
                            <h3><a href="<?= e(url('/cours/' . $cours['id'])) ?>"><?= e($cours['titre']) ?></a></h3>
                            ...
                            <div class="card-footer">
                                <a href="<?= e(url('/cours/' . $cours['id'])) ?>" class="btn btn-primary btn-sm">Voir le cours</a>
                            </div>
                        </div>
                    </article>
                <?php endforeach; ?>
