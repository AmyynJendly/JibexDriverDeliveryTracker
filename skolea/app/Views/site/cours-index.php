<section class="section" style="padding-bottom:24px;">
    <div class="container">
        ...
        <form method="get" action="<?= e(url('/cours')) ?>" class="card" style="margin-top:24px;">
...
<section class="section" style="padding-top:0;">
    <div class="container">
        <p class="text-soft" style="margin-bottom:18px;"><?= (int) $paginator->total ?> cours trouve(s).</p>

        <?php if ($cours === []): ?>
            <div class="empty-state card">
                <h3>Aucun cours ne correspond a votre recherche</h3>
                <p>Essayez d'autres criteres ou consultez le catalogue complet.</p>
                <a href="<?= e(url('/cours')) ?>" class="btn btn-outline">Reinitialiser les filtres</a>
            </div>
        <?php else: ?>
            <div class="grid grid-cols-3">
                <?php foreach ($cours as $c): ?>
                    <article class="card course-card">
                        ...
                        <div class="card-body">
                            <h3><a href="<?= e(url('/cours/' . $c['id'])) ?>"><?= e($c['titre']) ?></a></h3>
                            ...
                            <div class="card-footer">
                                ...
                                <a href="<?= e(url('/cours/' . $c['id'])) ?>" class="btn btn-primary btn-sm">Voir le cours</a>
                            </div>
                        </div>
                    </article>
                <?php endforeach; ?>
